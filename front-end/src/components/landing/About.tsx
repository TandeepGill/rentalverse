          ...
          <div className='mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row'>
            <div className='lg:w-full lg:max-w-2xl lg:flex-auto'>
              ...
              <p className='mt-10 max-w-xl text-base leading-7 text-gray-700'>
                That's why we've developed an innovative platform solution that
                simplifies every aspect of property management, from tenant
                communication to financial tracking and maintenance
